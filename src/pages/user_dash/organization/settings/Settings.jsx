  ...
  return (
    <div className="org-settings-container">
          ...
          <div className="col-md-4 d-flex flex-column align-items-center justify-content-center">
            ...
            {isLoading ? (
              ...
              <>
                ...
                />
                {isUploadingLogo && (
                  <p className="text-muted">Uploading logo...</p>
                )}
              </>
            ) : (
              <div
            ...
            {isLoading ? (
              ...
              <label
                className="org-settings-upload-logo-btn"
      ...
      <div className="row  mt-4">
        <div className="col-lg-12 text-lg-end" onClick={handleCompanySave}>
