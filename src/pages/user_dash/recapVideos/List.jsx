                    ...
                    {recapMaterials.length === 0 && !loading ? (
                        ...
                        recapMaterials.map((material) => (
                            <div key={material.id} className='col-lg-6'>
                                <div className="recap-video-card" onClick={() => navigate(`/recap-videos/${material.slug}`)}>
                                    {loading ? (
                                    ...
                                    <div>
                                        <h4 className="recap-video-head mb-0">
                                            {loading ? (
                                                ...
                                                material.title.slice(0, 25) || "Intro to Machine Learning"
                                            )}
                                        </h4>
                                        ...
                                        <p className='recap-video-description'>
                                            {loading ? (
                                                ...
                                                material.description.slice(0, 100) || "A brief overview of machine learning concepts and applications."
                                            )}
                                        </p>
                                    </div>
                                </div>
