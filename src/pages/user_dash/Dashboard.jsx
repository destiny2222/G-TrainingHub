            ...
            <div className="container p-4 min-vh-100">
                ...
                <section className="p-4 mb-4 d-flex justify-content-between align-items-center">
                    <div className="welcome-head">
                        ...
                        <p className="welcome-text-subtitle mb-3">
                            {isLoading ? <Skeleton width={250} /> : 'You have 2 assignments due this week.'}
                        </p>
                    </div>
                    <div className="d-flex flex-wrap justify-content-end">
                        {isLoading ? (
                            <Skeleton width={180} height={40} count={3} style={{ marginRight: '12px', marginBottom: '8px' }} />
                        ) : (
                            <>
                ...
                <div className="row">
                    <div className="col-12 col-lg-8 d-flex flex-column">
                        ...
                        <div className="card  mb-4" style={{ boxShadow: 'rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px' }}>
                            <div className="card-body">
                                <div className="d-flex align-items-center">
                                    {isLoading ? (
                                        <Skeleton width={100} height={100} style={{ marginRight: '12px' }} />
                                    ) : (
                                        <img src={cohort?.course?.thumbnail_path} alt="Course thumbnail" className="rounded img-fluid me-3" style={{ width: '100px', height: '100px', objectFit: 'cover' }} />
                                    )}
                                    <div className="flex-grow-1">
                                        ...
                                        <div className="d-flex justify-content-between align-items-center">
                                            <span className="small">
                                                {isLoading ? <Skeleton width={80} /> : `Progress: ${userEnrolledCohorts.progress}%`}
                                            </span>
                                            <button type='button'
                                            ...
                                            >
                                                {isLoading ? <Skeleton width={120} /> : (canJoin ? "Join Class" : "Class not live yet")}
                                            </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="col-12 col-lg-4 d-flex flex-column">
                                ...
                                <div className="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h4 className="h6 fw-medium mb-0">
                                            {isLoading ? <Skeleton width={100} /> : "Intro to Machine Learning"}
                                        </h4>
                        ...
                        <div className="card shadow-sm mb-4">
                            <div className="card-body">
                                <div className="d-flex align-items-center">
                                    {isLoading ? (
                                        <Skeleton width={80} height={50} style={{ marginRight: '12px' }} />
                                    ) : (
                                        <img src={cohortImage} alt="Video thumbnail" className="rounded me-3" style={{ width: '80px', height: '50px', objectFit: 'cover' }} />
                                    )}
                                    <div>
                                        <h4 className="h6 fw-medium mb-0">
                                            {isLoading ? <Skeleton width={120} /> : "Deep Learning Fundamentals"}
                                        </h4>
                                        <p className="text-muted small mb-0">
                ...
                <div className="row">
                        ...
                        <div className="card shadow-sm">
                            <div className="card-body">
                                <div className="table-responsive">
                                    {isLoading ? (
                                        <Skeleton count={4} height={40} style={{ marginBottom: '8px' }} />
                                    ) : (
                    ...
                    <div className="col-12 col-lg-4">
                        ...
                        <div className="card shadow-sm">
                            <div className="card-body">
                                {isLoading ? (
                                    <Skeleton width={250} height={150} style={{ marginBottom: '12px' }} />
                                ) : (
                                    <img src={cohortImage} alt="Tech library" className="img-fluid rounded mb-3" />
                                )}
                                <h3 className="h6 fw-medium mb-2">
                                    {isLoading ? <Skeleton width={180} /> : "Explore the Tech Library"}
                                </h3>
                                <p className="text-muted small mb-3">
                                    {isLoading ? <Skeleton width={220} /> : "Access a wide range of books, articles, and resources to supplement your learning."}
                                </p>
